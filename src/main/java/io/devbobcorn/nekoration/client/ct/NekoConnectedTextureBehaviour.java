...
public abstract class NekoConnectedTextureBehaviour {
    ...
    @Nullable
    public abstract NekoCTType getDataType(BlockAndTintGetter world, BlockPos pos, BlockState state, Direction direction);
    ...
    public CTContext buildContext(BlockAndTintGetter reader, BlockPos pos, BlockState state, Direction face,
        ...
        int sh = reverseUVsHorizontally(state, face) ? -1 : 1;
    ...
    private boolean testConnection(BlockAndTintGetter reader, BlockPos currentPos, BlockState connectiveCurrentState,
            Direction textureSide, Direction horizontal, Direction vertical, int sh, int sv) {
    ...
    protected boolean isBeingBlocked(BlockState state, BlockAndTintGetter reader, BlockPos pos, BlockPos otherPos,
        ...
        return connectsTo(state, getCTBlockState(reader, blockState, face.getOpposite(), pos.relative(face), blockingPos), reader,
                pos, blockingPos, face);
    }
