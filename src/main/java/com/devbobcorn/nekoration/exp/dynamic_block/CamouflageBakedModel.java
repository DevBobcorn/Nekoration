 ...
 * rendering of the camouflage block, based on the block it is copying. It uses
 * the IForgeBakedModel extension of IBakedModel to pass IModelData (blockstate
 * to be copied) to the getQuads. In this case, the getQuads just looks up the
