...
public class BlockCamouflage extends Block {
  ...
  {
    super(Block.Properties.of(Material.DECORATION).noCollission()  // look at Block.Properties for further options
            //notOpaque().notSolid()
    );
  }
  ...
  public static Optional<BlockState> selectBestAdjacentBlock(@Nonnull IBlockDisplayReader world, @Nonnull BlockPos blockPos)
  {
    ...
    for (Direction facing : Direction.values()) {
      ...
      if (!adjacentBlock.isAir(adjacentBS, world, adjacentPosition)
          && adjacentBS.isSolidRender(world, adjacentPosition)) {
