...
public class ModBlockEntityType {
    ...
    public static final RegistryObject<BlockEntityType<ItemDisplayBlockEntity>> ITEM_DISPLAY_TYPE = TILE_ENTITY_TYPES.register("item_display", () -> BlockEntityType.Builder.of(ItemDisplayBlockEntity::new, ModBlocks.CUPBOARD.get(), ModBlocks.SHELF.get(), ModBlocks.WALL_SHELF.get()).build(null));
}
