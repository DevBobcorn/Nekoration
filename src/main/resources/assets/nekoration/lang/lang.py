...
stone_block_ids = ["polished_smooth_{stone}", "polished_smooth_{stone}_slab", "polished_smooth_{stone}_stairs", "chiseled_smooth_{stone}", "{stone}_base", "{stone}_column_doric", "{stone}_column_ionic", "{stone}_column_corinthian", "{stone}_pot"]
stone_blocks_us = ["Polished Smooth {stone}", "Polished Smooth {stone} Slab", "Polished Smooth {stone} Stairs", "Chiseled Smooth {stone}", "{stone} Base", "{stone} Doric Column", "{stone} Ionic Column", "{stone} Corinthian Column", "{stone} Pot"]
stone_blocks_cn = ["磨制平滑{stone}", "磨制平滑{stone}台阶", "磨制平滑{stone}楼梯", "錾制平滑{stone}", "{stone}底座", "{stone}多立克柱", "{stone}爱奥尼柱", "{stone}科林斯柱", "{stone}花盆"]
