...
stone_block_ids = ["polished_smooth_{stone}", "polished_smooth_{stone}_slab", "polished_smooth_{stone}_stairs", "{stone}_bricks", "{stone}_bricks_slab", "{stone}_bricks_stairs", "{stone}_tiles", "{stone}_tiles_slab", "{stone}_tiles_stairs", "chiseled_smooth_{stone}", "horizontal_chiseled_smooth_{stone}", "chiseled_{stone}", "chiseled_{stone}_bricks", "{stone}_pedestal", "{stone}_column_doric", "{stone}_column_ionic", "{stone}_column_corinthian",
