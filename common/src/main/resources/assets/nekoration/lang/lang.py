...
woods_cn = ["橡木", "云杉木", "白桦木", "丛林木", "金合欢木", "深色橡木", "红树木", "樱花木", "竹", "绯红木", "诡异木", "冷杉木", "松木", "枫木", "红木", "桃花心木", "蓝花楹木", "棕榈木", "柳木", "垂死木", "魔法木", "暗影木", "地狱皮木", "天界木"]
...
cement_ids = ["cement", "cement_base", "paneled_cement", "paneled_cement_base", "cement_pillar_simple", "cement_pillar_doric", "cement_pillar_ionic", "cement_pillar_corinthian", "cement_pillar_base", "cement_thin_pillar_simple", "cement_thin_pillar_doric", "cement_thin_pillar_ionic", "cement_thin_pillar_corinthian", "layered_cement", "cement_frame_head", "cement_frame_peak", "cement_frame_side", "cement_frame_sill", "cement_pedestal", "cement_pot", "cement_planter"]
cements_us = ["%s Cement", "%s Cement Base", "%s Paneled Cement", "%s Paneled Cement Base", "%s Simple Cement Pillar", "%s Doric Cement Pillar", "%s Ionic Cement Pillar", "%s Corinthian Cement Pillar", "%s Cement Pillar Base", "%s Simple Cement Thin Pillar", "%s Doric Cement Thin Pillar", "%s Ionic Cement Thin Pillar", "%s Corinthian Cement Thin Pillar", "%s Layered Cement", "%s Cement Frame Head", "%s Cement Frame Peak", "%s Cement Frame Side", "%s Cement Frame Sill", "%s Cement Pedestal", "%s Cement Pot", "%s Cement Planter"]
cements_cn = ["%s水泥", "%s水泥基座", "%s镶板水泥", "%s镶板水泥基座", "%s简易水泥柱", "%s多立克水泥柱", "%s爱奥尼水泥柱", "%s科林斯水泥柱", "%s水泥柱基座", "%s简易水泥饰柱", "%s多立克水泥饰柱", "%s爱奥尼水泥饰柱", "%s科林斯水泥饰柱", "%s层叠水泥", "%s水泥框顶边", "%s水泥框尖顶", "%s水泥框侧边", "%s水泥框底边", "%s水泥底座", "%s水泥花盆", "%s水泥种植盆"]
...
stone_block_ids = ["polished_smooth_{stone}", "polished_smooth_{stone}_slab", "polished_smooth_{stone}_stairs", "{stone}_bricks", "{stone}_brick_slab", "{stone}_brick_stairs", "{stone}_tiles", "{stone}_tile_slab", "{stone}_tile_stairs", "chiseled_smooth_{stone}", "horizontal_chiseled_smooth_{stone}", "chiseled_{stone}", "chiseled_{stone}_bricks", "{stone}_pedestal", "{stone}_pillar_simple", "{stone}_pillar_doric", "{stone}_pillar_ionic", "{stone}_pillar_corinthian", "{stone}_pillar_base", "{stone}_thin_pillar_simple", "{stone}_thin_pillar_doric", "{stone}_thin_pillar_ionic", "{stone}_thin_pillar_corinthian",
    "{stone}_frame_head",  "{stone}_frame_peak","{stone}_frame_side", "{stone}_frame_sill", "{stone}_pot", "{stone}_planter"]
stone_blocks_us = ["Polished Smooth {stone}", "Polished Smooth {stone} Slab", "Polished Smooth {stone} Stairs", "{stone} Bricks", "{stone} Brick Slab", "{stone} Brick Stairs", "{stone} Tiles", "{stone} Tile Slab", "{stone} Tile Stairs", "Chiseled Smooth {stone}", "Horizontal Chiseled Smooth {stone}", "Chiseled {stone}", "Chiseled {stone} Bricks", "{stone} Pedestal", "Simple {stone} Pillar", "Doric {stone} Pillar", "Ionic {stone} Pillar", "Corinthian {stone} Pillar", "{stone} Pillar Base", "Simple {stone} Thin Pillar", "Doric {stone} Thin Pillar", "Ionic {stone} Thin Pillar", "Corinthian {stone} Thin Pillar",
    "{stone} Frame Head",  "{stone} Frame Peak","{stone} Frame Side", "{stone} Frame Sill", "{stone} Pot", "{stone} Planter"]
stone_blocks_cn = ["磨制平滑{stone}", "磨制平滑{stone}台阶", "磨制平滑{stone}楼梯", "{stone}砖", "{stone}砖台阶", "{stone}砖楼梯", "{stone}瓦", "{stone}瓦台阶", "{stone}瓦楼梯", "雕纹平滑{stone}", "横向雕纹平滑{stone}", "雕纹{stone}", "雕纹{stone}砖", "{stone}底座", "简易{stone}柱", "多立克{stone}柱", "爱奥尼{stone}柱", "科林斯{stone}柱", "{stone}柱基座", "简易{stone}饰柱", "多立克{stone}饰柱", "爱奥尼{stone}饰柱", "科林斯{stone}饰柱",
