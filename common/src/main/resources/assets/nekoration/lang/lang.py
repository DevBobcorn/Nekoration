...
stone_block_ids = ["polished_smooth_{stone}", "polished_smooth_{stone}_slab", "polished_smooth_{stone}_stairs", "{stone}_bricks", "{stone}_brick_slab", "{stone}_brick_stairs", "{stone}_tiles", "{stone}_tile_slab", "{stone}_tile_stairs", "chiseled_smooth_{stone}", "horizontal_chiseled_smooth_{stone}", "chiseled_{stone}", "chiseled_{stone}_bricks", "{stone}_pedestal", "{stone}_thin_pillar_doric", "{stone}_thin_pillar_ionic", "{stone}_thin_pillar_corinthian",
    "{stone}_frame_head",  "{stone}_frame_peak","{stone}_frame_side", "{stone}_frame_sill", "{stone}_pot", "{stone}_planter"]
stone_blocks_us = ["Polished Smooth {stone}", "Polished Smooth {stone} Slab", "Polished Smooth {stone} Stairs", "{stone} Bricks", "{stone} Brick Slab", "{stone} Brick Stairs", "{stone} Tiles", "{stone} Tile Slab", "{stone} Tile Stairs", "Chiseled Smooth {stone}", "Horizontal Chiseled Smooth {stone}", "Chiseled {stone}", "Chiseled {stone} Bricks", "{stone} Pedestal", "Doric {stone} Thin Pillar", "Ionic {stone} Thin Pillar", "Corinthian {stone} Thin Pillar",
    "{stone} Frame Head",  "{stone} Frame Peak","{stone} Frame Side", "{stone} Frame Sill", "{stone} Pot", "{stone} Planter"]
stone_blocks_cn = ["磨制平滑{stone}", "磨制平滑{stone}台阶", "磨制平滑{stone}楼梯", "{stone}砖", "{stone}砖台阶", "{stone}砖楼梯", "{stone}瓦", "{stone}瓦台阶", "{stone}瓦楼梯", "雕纹平滑{stone}", "横向雕纹平滑{stone}", "雕纹{stone}", "雕纹{stone}砖", "{stone}底座", "多立克{stone}饰柱", "爱奥尼{stone}饰柱", "科林斯{stone}饰柱",
