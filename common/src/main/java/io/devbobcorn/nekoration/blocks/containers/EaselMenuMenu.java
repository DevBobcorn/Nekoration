...
public class EaselMenuMenu extends AbstractContainerMenu {
    ...
    /** Menu type factory: resolves the easel block entity from the opening position. */
    public static EaselMenuMenu fromPosition(int containerId, Inventory playerInventory, BlockPos pos) {
        return new EaselMenuMenu(containerId, playerInventory, resolveEasel(playerInventory, pos));
    }
    ...
    private static EaselMenuBlockEntity resolveEasel(Inventory inventory, BlockPos pos) {
        if (pos == null) {
